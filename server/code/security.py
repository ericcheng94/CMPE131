...
def validate_data(account, data, user_id, type):
    ...
    if how_many_accounts['accounts'] == 0:
        return {'message': f'You must open at least one banking account to {type}'}, 400 # bad request
    ...
    # check if money withdrawal amount is greater than 0 and less than or equal to balance
